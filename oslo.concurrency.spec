...
Source0  : http://tarballs.openstack.org/oslo.concurrency/oslo.concurrency-4.2.0.tar.gz
Source1  : http://tarballs.openstack.org/oslo.concurrency/oslo.concurrency-4.2.0.tar.gz.asc
...
%prep
%setup -q -n oslo.concurrency-4.2.0
cd %{_builddir}/oslo.concurrency-4.2.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1593467408
...
cp %{_builddir}/oslo.concurrency-4.2.0/LICENSE %{buildroot}/usr/share/package-licenses/oslo.concurrency/57aed0b0f74e63f6b85cce11bce29ba1710b422b
