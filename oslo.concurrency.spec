...
%prep
%setup -q -n oslo.concurrency-4.0.1
cd %{_builddir}/oslo.concurrency-4.0.1
...
cp %{_builddir}/oslo.concurrency-4.0.1/LICENSE %{buildroot}/usr/share/package-licenses/oslo.concurrency/57aed0b0f74e63f6b85cce11bce29ba1710b422b
