...
Version  : 2.8.0
Release  : 24
URL      : http://tarballs.openstack.org/oslo.concurrency/oslo.concurrency-2.8.0.tar.gz
Source0  : http://tarballs.openstack.org/oslo.concurrency/oslo.concurrency-2.8.0.tar.gz
...
%prep
%setup -q -n oslo.concurrency-2.8.0
