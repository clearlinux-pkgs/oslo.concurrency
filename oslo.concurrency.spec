...
Version  : 4.0.2
Release  : 67
URL      : http://tarballs.openstack.org/oslo.concurrency/oslo.concurrency-4.0.2.tar.gz
Source0  : http://tarballs.openstack.org/oslo.concurrency/oslo.concurrency-4.0.2.tar.gz
Source1  : http://tarballs.openstack.org/oslo.concurrency/oslo.concurrency-4.0.2.tar.gz.asc
...
%prep
%setup -q -n oslo.concurrency-4.0.2
cd %{_builddir}/oslo.concurrency-4.0.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1586272627
...
cp %{_builddir}/oslo.concurrency-4.0.2/LICENSE %{buildroot}/usr/share/package-licenses/oslo.concurrency/57aed0b0f74e63f6b85cce11bce29ba1710b422b
