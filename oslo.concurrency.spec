...
%prep
%setup -q -n oslo.concurrency-4.3.0
cd %{_builddir}/oslo.concurrency-4.3.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1600109072
...
cp %{_builddir}/oslo.concurrency-4.3.0/LICENSE %{buildroot}/usr/share/package-licenses/oslo.concurrency/57aed0b0f74e63f6b85cce11bce29ba1710b422b
